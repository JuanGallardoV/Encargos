...
<body class=>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color: #F9D5A7;">
            <div class="container">
                {{-- <a class="navbar-brand" href="{{ url('/') }}">
                    <img class="shop animate__animated animate__bounceInDown" src="{{asset('img/ultimate-shop.gif')}}" width="50" height="50">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('cambios')}}">Historial de Cambios</a>
                        </li>
                        @endif
                    </ul>
